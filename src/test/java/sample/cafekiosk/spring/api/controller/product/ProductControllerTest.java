...
import sample.cafekiosk.spring.api.ProductController;
...
class ProductControllerTest {
    ...
    @DisplayName("신규 상품을 등록할 때 상품 판매상태는은 필수값이다.")
    @Test
    public void createProductWithSellingStatus() throws Exception {
        //given
        ProductCreateRequest request = ProductCreateRequest.builder()
                .type(HANDMADE)
                .name("아메리카노")
